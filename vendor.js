/*! For license information please see vendor.f665a0509c5fda9b717a.js.LICENSE.txt */
(self.webpackChunklegion_solver = self.webpackChunklegion_solver || []).push([[736], {
    645: n=>{
        "use strict";
        n.exports = function(n) {
            ...
            t.i = function(n, r, e) {
                ...
                for (var f = 0; f < n.length; f++) {
                    var a = [].concat(n[f]);
                    e && u[a[0]] || (r && (a[2] ? a[2] = "".concat(r, " and ").concat(a[2]) : a[2] = r),
                    t.push(a))
                }
            }
            ,
    ...
    486: function(n, t, r) {
        ...
        n = r.nmd(n),
        function() {
            var u, i = "Expected a function", o = "__lodash_hash_undefined__", f = "__lodash_placeholder__", a = 32, c = 128, l = 1 / 0, s = 9007199254740991, h = NaN, p = 4294967295, v = [["ary", c], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", 16], ["flip", 512], ["partial", a], ["partialRight", 64], ["rearg", 256]], _ = "[object Arguments]", g = "[object Array]", y = "[object Boolean]", d = "[object Date]", b = "[object Error]", w = "[object Function]", m = "[object GeneratorFunction]", x = "[object Map]", j = "[object Number]", A = "[object Object]", k = "[object Promise]", O = "[object RegExp]", I = "[object Set]", E = "[object String]", S = "[object Symbol]", R = "[object WeakMap]", z = "[object ArrayBuffer]", C = "[object DataView]", L = "[object Float32Array]", W = "[object Float64Array]", T = "[object Int8Array]", B = "[object Int16Array]", U = "[object Int32Array]", $ = "[object Uint8Array]", M = "[object Uint8ClampedArray]", D = "[object Uint16Array]", N = "[object Uint32Array]", F = /\b__p \+= '';/g, P = /\b(__p \+=) '' \+/g, q = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Z = /&(?:amp|lt|gt|quot|#39);/g, K = /[&<>"']/g, V = RegExp(Z.source), G = RegExp(K.source), H = /<%-([\s\S]+?)%>/g, J = /<%([\s\S]+?)%>/g, Y = /<%=([\s\S]+?)%>/g, Q = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, X = /^\w*$/, nn = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, tn = /[\\^$.*+?()[\]{}|]/g, rn = RegExp(tn.source), en = /^\s+|\s+$/g, un = /^\s+/, on = /\s+$/, fn = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, an = /\{\n\/\* \[wrapped with (.+)\] \*/, cn = /,? & /, ln = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, sn = /\\(\\)?/g, hn = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, pn = /\w*$/, vn = /^[-+]0x[0-9a-f]+$/i, _n = /^0b[01]+$/i, gn = /^\[object .+?Constructor\]$/, yn = /^0o[0-7]+$/i, dn = /^(?:0|[1-9]\d*)$/, bn = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, wn = /($^)/, mn = /['\n\r\u2028\u2029\\]/g, xn = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", jn = "a-z\\xdf-\\xf6\\xf8-\\xff", An = "A-Z\\xc0-\\xd6\\xd8-\\xde", kn = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", On = "[" + kn + "]", In = "[" + xn + "]", En = "\\d+", Sn = "[" + jn + "]", Rn = "[^\\ud800-\\udfff" + kn + En + "\\u2700-\\u27bf" + jn + An + "]", zn = "\\ud83c[\\udffb-\\udfff]", Cn = "[^\\ud800-\\udfff]", Ln = "(?:\\ud83c[\\udde6-\\uddff]){2}", Wn = "[\\ud800-\\udbff][\\udc00-\\udfff]", Tn = "[" + An + "]", Bn = "(?:" + Sn + "|" + Rn + ")", Un = "(?:" + Tn + "|" + Rn + ")", $n = "(?:['’](?:d|ll|m|re|s|t|ve))?", Mn = "(?:['’](?:D|LL|M|RE|S|T|VE))?", Dn = "(?:" + In + "|" + zn + ")?", Nn = "[\\ufe0e\\ufe0f]?", Fn = Nn + Dn + "(?:\\u200d(?:" + [Cn, Ln, Wn].join("|") + ")" + Nn + Dn + ")*", Pn = "(?:" + ["[\\u2700-\\u27bf]", Ln, Wn].join("|") + ")" + Fn, qn = "(?:" + [Cn + In + "?", In, Ln, Wn, "[\\ud800-\\udfff]"].join("|") + ")", Zn = RegExp("['’]", "g"), Kn = RegExp(In, "g"), Vn = RegExp(zn + "(?=" + zn + ")|" + qn + Fn, "g"), Gn = RegExp([Tn + "?" + Sn + "+" + $n + "(?=" + [On, Tn, "$"].join("|") + ")", Un + "+" + Mn + "(?=" + [On, Tn + Bn, "$"].join("|") + ")", Tn + "?" + Bn + "+" + $n, Tn + "+" + Mn, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", En, Pn].join("|"), "g"), Hn = RegExp("[\\u200d\\ud800-\\udfff" + xn + "\\ufe0e\\ufe0f]"), Jn = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Yn = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], Qn = -1, Xn = {};
            Xn[L] = Xn[W] = Xn[T] = Xn[B] = Xn[U] = Xn[$] = Xn[M] = Xn[D] = Xn[N] = !0,
            Xn[_] = Xn[g] = Xn[z] = Xn[y] = Xn[C] = Xn[d] = Xn[b] = Xn[w] = Xn[x] = Xn[j] = Xn[A] = Xn[O] = Xn[I] = Xn[E] = Xn[R] = !1;
            var nt = {};
            nt[_] = nt[g] = nt[z] = nt[C] = nt[y] = nt[d] = nt[L] = nt[W] = nt[T] = nt[B] = nt[U] = nt[x] = nt[j] = nt[A] = nt[O] = nt[I] = nt[E] = nt[S] = nt[$] = nt[M] = nt[D] = nt[N] = !0,
            nt[b] = nt[w] = nt[R] = !1;
            var tt = {
                "\\": "\\",
                "'": "'",
            ...
            function ur(n) {
                return Qt(n) ? function(n) {
                    for (var t = Vn.lastIndex = 0; Vn.test(n); )
                        ++t;
                    return t
                }(n) : zt(n)
            }
            ...
            var or = Mt({
              ...
              , fr = function n(t) {
                var r, e = (t = null == t ? ot : fr.defaults(ot.Object(), t, fr.pick(ot, Yn))).Array, xn = t.Date, jn = t.Error, An = t.Function, kn = t.Math, On = t.Object, In = t.RegExp, En = t.String, Sn = t.TypeError, Rn = e.prototype, zn = An.prototype, Cn = On.prototype, Ln = t["__core-js_shared__"], Wn = zn.toString, Tn = Cn.hasOwnProperty, Bn = 0, Un = (r = /[^.]+$/.exec(Ln && Ln.keys && Ln.keys.IE_PROTO || "")) ? "Symbol(src)_1." + r : "", $n = Cn.toString, Mn = Wn.call(On), Dn = ot._, Nn = In("^" + Wn.call(Tn).replace(tn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Fn = ct ? t.Buffer : u, Pn = t.Symbol, qn = t.Uint8Array, Vn = Fn ? Fn.allocUnsafe : u, Hn = nr(On.getPrototypeOf, On), tt = On.create, ut = Cn.propertyIsEnumerable, it = Rn.splice, ft = Pn ? Pn.isConcatSpreadable : u, at = Pn ? Pn.iterator : u, lt = Pn ? Pn.toStringTag : u, st = function() {
                    try {
                        var n = ai(On, "defineProperty");
                        return n({}, "", {}),
                        n
                    } catch (n) {}
                }(), zt = t.clearTimeout !== ot.clearTimeout && t.clearTimeout, Mt = xn && xn.now !== ot.Date.now && xn.now, ar = t.setTimeout !== ot.setTimeout && t.setTimeout, cr = kn.ceil, lr = kn.floor, sr = On.getOwnPropertySymbols, hr = Fn ? Fn.isBuffer : u, pr = t.isFinite, vr = Rn.join, _r = nr(On.keys, On), gr = kn.max, yr = kn.min, dr = xn.now, br = t.parseInt, wr = kn.random, mr = Rn.reverse, xr = ai(t, "DataView"), jr = ai(t, "Map"), Ar = ai(t, "Promise"), kr = ai(t, "Set"), Or = ai(t, "WeakMap"), Ir = ai(On, "create"), Er = Or && new Or, Sr = {}, Rr = Ui(xr), zr = Ui(jr), Cr = Ui(Ar), Lr = Ui(kr), Wr = Ui(Or), Tr = Pn ? Pn.prototype : u, Br = Tr ? Tr.valueOf : u, Ur = Tr ? Tr.toString : u;
                function $r(n) {
                    if (tf(n) && !qo(n) && !(n instanceof Fr)) {
                        if (n instanceof Nr)
                            return n;
                        if (Tn.call(n, "__wrapped__"))
                            return $i(n)
                    }
                    return new Nr(n)
                }
                ...
                function Gr(n, t) {
                    var r = qo(n)
                      ...
                      , a = f.length;
                    for (var c in n)
                        !t && !Tn.call(n, c) || o && ("length" == c || u && ("offset" == c || "parent" == c) || i && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || _i(c, a)) || f.push(c);
                    return f
                }
                function Hr(n) {
                    var t = n.length;
                ...
                function oe(n, t, r, e, i, o) {
                    ...
                    if (s) {
                        if (f = function(n) {
                            ...
                            return t && "string" == typeof n[0] && Tn.call(n, "index") && (r.index = n.index,
                            r.input = n.input),
                            r
                        }(n),
                        !a)
                ...
                qr.prototype.delete = function(n) {
                    var t = this.__data__
                      , r = ne(t, n);
                    return !(r < 0 || (r == t.length - 1 ? t.pop() : it.call(t, r, 1),
                    --this.size,
                    0))
                }
                ,
                ...
                function Ie(n, t, r) {
                    for (var i = r ? kt : At, o = n[0].length, f = n.length, a = f, c = e(f), l = 1 / 0, s = []; a--; ) {
                        ...
                        a && t && (h = Ot(h, Pt(t))),
                        l = yr(h.length, l),
                        c[a] = !r && (t || o >= 120 && h.length >= 120) ? new Kr(a && h) : u
                    }
                    h = n[0];
                    var p = -1
                      , v = c[0];
                ...
                function Re(n, t, r, e, i) {
                    return n === t || (null == n || null == t || !tf(n) && !tf(t) ? n != n && t != t : function(n, t, r, e, i, o) {
                        ...
                        if (p && !s)
                            return o || (o = new Vr),
                            f || lf(n) ? Qu(n, t, r, e, i, o) : function(n, t, r, e, u, i, o) {
                                switch (r) {
                                case C:
                ...
                function Ce(n) {
                    return !(!nf(n) || (t = n,
                    Un && Un in t)) && (Yo(n) ? Nn : gn).test(Ui(n));
                    var t
                }
                function Le(n) {
                                ...
                                if (l)
                                    ...
                                    if (h) {
                                        var p = qo(c)
                                          ...
                                          , _ = !p && !v && lf(c);
                                        s = c,
                                        p || v || _ ? qo(a) ? s = a : Vo(a) ? s = Ou(a) : v ? (h = !1,
                                        s = wu(c, !0)) : _ ? (h = !1,
                                        s = xu(c, !0)) : s = [] : uf(c) || Po(c) ? (s = a,
                                        Po(a) ? s = df(a) : nf(a) && !Yo(a) || (s = pi(c))) : h = !1
                                    }
                                    h && (f.set(c, s),
                                    i(s, c, e, o, f),
                                    f.delete(c)),
                ...
                function Au(n, t, r, u) {
                    for (var i = -1, o = n.length, f = r.length, a = -1, c = t.length, l = gr(o - f, 0), s = e(c + l), h = !u; ++a < c; )
                        s[a] = t[a];
                    for (; ++i < f; )
                        (h || i < o) && (s[r[i]] = n[i]);
                    for (; l--; )
                ...
                function ku(n, t, r, u) {
                    for (var i = -1, o = n.length, f = -1, a = r.length, c = -1, l = t.length, s = gr(o - a, 0), h = e(s + l), p = !u; ++i < s; )
                        h[i] = n[i];
                    for (var v = i; ++c < l; )
                        h[v + c] = t[c];
                    for (; ++f < a; )
                ...
                function Ru(n, t) {
                    return function(r, e) {
                        ...
                        if (!Ko(r))
                            return n(r, e);
                        for (var u = r.length, i = t ? u : -1, o = On(r); (t ? i-- : ++i < u) && !1 !== e(o[i], i, o); )
                            ;
                        return r
                    }
                }
                ...
                function Uu(n, t, r, i, o, f, a, l, s, h) {
                    ...
                    return function u() {
                        ...
                        p && s < c && (b.length = s),
                        this && this !== ot && this instanceof u && (k = d || Wu(k)),
                        k.apply(A, b)
                    }
                }
                function $u(n, t) {
                ...
                function Mu(n, t) {
                    return function(r, e) {
                        ...
                        e !== u) {
                            if (i === u)
                                return e;
                            "string" == typeof r || "string" == typeof e ? (r = ou(r),
                            e = ou(e)) : (r = iu(r),
                            e = iu(e)),
                            i = n(r, e)
                        }
                ...
                function Fu(n) {
                    return function(t, r, i) {
                        return i && "number" != typeof i && gi(t, r, i) && (r = i = u),
                        t = vf(t),
                        r === u ? (r = t,
                        t = 0) : r = vf(r),
                        function(n, t, r, u) {
                ...
                function Pu(n) {
                    return function(t, r) {
                        return "string" == typeof t && "string" == typeof r || (t = yf(t),
                        r = yf(r)),
                        n(t, r)
                    }
                }
                ...
                function Gu(n, t, r, o, l, s, h, p) {
                    ...
                    if (d && function(n, t) {
                        ...
                        n[6] = l ? tr(n[5], f) : t[6]),
                        (a = t[7]) && (n[7] = a),
                        e & c && (n[8] = null == n[8] ? t[8] : yr(n[8], t[8])),
                        null == n[9] && (n[9] = t[9]),
                        n[0] = t[0],
                        n[1] = u
                    }(b, d),
                    ...
                    o = b[3],
                    l = b[4],
                    !(p = b[9] = b[9] === u ? v ? 0 : n.length : gr(b[9] - _, 0)) && 24 & t && (t &= -25),
                    t && 1 != t)
                        w = 8 == t || 16 == t ? function(n, t, r) {
                            var i = Wu(n);
                            return function o() {
                                for (var f = arguments.length, a = e(f), c = f, l = ui(o); c--; )
                                    a[c] = arguments[c];
                            ...
                            var i = 1 & t
                              , o = Wu(n);
                            return function t() {
                                for (var f = -1, a = arguments.length, c = -1, l = u.length, s = e(l + a), h = this && this !== ot && this instanceof t ? o : n; ++c < l; )
                                    s[c] = u[c];
                                for (; a--; )
                                    s[c++] = arguments[++f];
                ...
                function di(n) {
                    var t = ei(n)
                      , r = $r[t];
                    if ("function" != typeof r || !(t in Fr.prototype))
                        return !1;
                    if (n === r)
                        return !0;
                    var e = ri(r);
                ...
                function $i(n) {
                    ...
                    return t.__actions__ = Ou(n.__actions__),
                ...
                function zo(n, t, r) {
                    ...
                    return t = yf(t) || 0,
                    nf(r) && (h = !!r.leading,
                    f = (p = "maxWait"in r) ? gr(yf(r.maxWait) || 0, t) : f,
                ...
                function Wo(n, t) {
                    ...
                    return r.cache = new (Wo.Cache || Zr),
                    r
                }
                function To(n) {
                    if ("function" != typeof n)
                ...
                function aa(n, t, r) {
                    var e = Cf(t)
                      , u = we(t, e);
                    null != r || nf(t) && (u.length || !e.length) || (r = t,
                    t = n,
                    n = this,
                    u = we(t, Cf(t)));
                ...
                ), 0), wa = Zu("ceil"), ma = Mu((function(n, t) {
                    return n / t
                }
                ), 1), xa = Zu("floor"), ja = Mu((function(n, t) {
                    return n * t
                }
                ), 1), Aa = Zu("round"), ka = Mu((function(n, t) {
                    return n - t
                }
                ), 0);
                ...
                $r.fill = function(n, t, r, e) {
                    var i = null == n ? 0 : n.length;
                    return i ? (r && "number" != typeof r && gi(n, t, r) && (r = 0,
                    e = i),
                    function(n, t, r, e) {
                        var i = n.length;
                        for ((r = _f(r)) < 0 && (r = -r > i ? 0 : i + r),
                ...
                $r.sampleSize = function(n, t, r) {
                    return t = (r ? gi(n, t, r) : t === u) ? 1 : _f(t),
                    (qo(n) ? Jr : He)(n, t)
                }
                ,
                ...
                $r.slice = function(n, t, r) {
                    var e = null == n ? 0 : n.length;
                    return e ? (r && "number" != typeof r && gi(n, t, r) ? (t = 0,
                    r = e) : (t = null == t ? 0 : _f(t),
                    r = r === u ? e : _f(r)),
                    nu(n, t, r)) : []
                }
                ...
                $r.split = function(n, t, r) {
                    return r && "number" != typeof r && gi(n, t, r) && (t = r = u),
                    (r = r === u ? p : r >>> 0) ? (n = bf(n)) && ("string" == typeof t || null != t && !of(t)) && !(t = ou(t)) && Qt(n) ? du(ir(n), 0, r) : n.split(t, r) : []
                }
                ,
                $r.spread = function(n, t) {
                    if ("function" != typeof n)
                        throw new Sn(i);
                    return t = null == t ? 0 : gr(_f(t), 0),
                    Ve((function(r) {
                        var e = r[t]
                          , u = du(r, 0, t);
                        return e && It(u, e),
                ...
                $r.throttle = function(n, t, r) {
                    ...
                    if ("function" != typeof n)
                        throw new Sn(i);
                    return nf(r) && (e = "leading"in r ? !!r.leading : e,
                ...
                $r.includes = function(n, t, r, e) {
                    ...
                    r = r && !e ? _f(r) : 0;
                    var u = n.length;
                    return r < 0 && (r = gr(u + r, 0)),
                    af(n) ? r <= u && n.indexOf(t, r) > -1 : !!u && Wt(n, t, r) > -1
                }
                ,
                ...
                $r.isEmpty = function(n) {
                    if (null == n)
                        return !0;
                    if (Ko(n) && (qo(n) || "string" == typeof n || "function" == typeof n.splice || Go(n) || lf(n) || Po(n)))
                        return !n.length;
                    var t = si(n);
                    if (t == x || t == I)
                        return !n.size;
                ...
                $r.isNative = function(n) {
                    if (bi(n))
                        throw new jn("Unsupported core-js use. Try https://npms.io/search?q=ponyfill.");
                    return Ce(n)
                }
                ,
                $r.isNil = function(n) {
                ...
                $r.lastIndexOf = function(n, t, r) {
                    ...
                    if (!e)
                        return -1;
                    var i = e;
                    return r !== u && (i = (i = _f(r)) < 0 ? gr(e + i, 0) : yr(i, e - 1)),
                    t == t ? function(n, t, r) {
                        for (var e = r + 1; e--; )
                            if (n[e] === t)
                                return e;
                ...
                $r.random = function(n, t, r) {
                    if (r && "boolean" != typeof r && gi(n, t, r) && (t = r = u),
                ...
                $r.template = function(n, t, r) {
                    ...
                    n = bf(n),
                    t = xf({}, t, e, Hu);
                    var i, o, f = xf({}, t.imports, e.imports, Hu), a = Cf(f), c = qt(f, a), l = 0, s = t.interpolate || wn, h = "__p += '", p = In((t.escape || wn).source + "|" + s.source + "|" + (s === Y ? hn : wn).source + "|" + (t.evaluate || wn).source + "|$", "g"), v = "//# sourceURL=" + (Tn.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Qn + "]") + "\n";
                ...
                $r.truncate = function(n, t) {
                    ...
                    of(i)) {
                        if (n.slice(a).search(i)) {
                            var l, s = c;
                            for (i.global || (i = In(i.source, bf(pn.exec(i)) + "g")),
                ...
                Fr.prototype.slice = function(n, t) {
                    n = _f(n);
                    var r = this;
                    return r.__filtered__ && (n > 0 || t < 0) ? new Fr(r) : (n < 0 ? r = r.takeRight(-n) : n && (r = r.drop(n)),
                ...
                Fr.prototype.clone = function() {
                    ...
                    return n.__actions__ = Ou(this.__actions__),
                ...
                $r.prototype.reverse = function() {
                    ...
                    if (n instanceof Fr) {
                        var t = n;
                        return this.__actions__.length && (t = new Fr(this)),
    ...
    379: (n,t,r)=>{
        ...
        function h(n, t, r) {
            var e = r.css
              , u = r.media
              , i = r.sourceMap;
            if (u ? n.setAttribute("media", u) : n.removeAttribute("media"),
        ...
        n.exports = function(n, t) {
            (t = t || {}).singleton || "boolean" == typeof t.singleton || (t.singleton = (void 0 === e && (e = Boolean(window && document && document.all && !window.atob)),
            e));
            var r = f(n = n || [], t);
            return function(n) {
                if (n = n || [],
